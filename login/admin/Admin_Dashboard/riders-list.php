...
$result = mysqli_query($mysqli, "SELECT * FROM rider ORDER BY id DESC");
?>
											...
											<table class="table text-black card-table  mb-4 table-responsive-lg dataTablesCard" id="dataTable1">
                                                ...
                                                <tr>  
                                                    ...
                                                    while($user_data = mysqli_fetch_array($result)) {
                                                        ...
                                                        echo "<td>".$user_data['Driverable_Vehicles']."</td>";
                                                        echo "<td>".$user_data['License']."</td>";
                                                        echo "<td>".$user_data['Certificate']."</td>";        
                                                        echo "<td>".$user_data['Password']."</td>";
                                                        echo "<td><a href='edit_rider.php?id=$user_data[id]'>Edit</a> | <a href='delete_rider.php?id=$user_data[id]'>Delete</a></td></tr>";
                                                    }
                                                    ?>
