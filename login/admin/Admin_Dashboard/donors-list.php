...
$result = mysqli_query($mysqli, "SELECT * FROM donor ORDER BY id DESC");
?>
							...
							<div class="card-header flex-wrap border-0 p-0 justify-content-start">
								<div class="table-tabs mr-2 mb-3 mr-auto">
									<ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item">
                                           <div class="d-flex flex-wrap mb-3"><a href="add_donor.php" data-target="#addContactModal" class="btn btn-outline-primary  mr-auto mb-2">Add New Donor</a>	
										</li>
										...
										<div class="table-responsive rounded table-hover">
											<table class="table text-black card-table  mb-4 table-responsive-lg dataTablesCard" id="dataTable1">
                                                ...
                                                while($user_data = mysqli_fetch_array($result)) {
                                                    ...
                                                    echo "<td>".$user_data['Join_Date']."</td>";
                                                    echo "<td>".$user_data['Donor_Name']."</td>";
                                                    echo "<td>".$user_data['Location']."</td>";               
                                                    echo "<td>".$user_data['Donated_Amount']."</td>";
                                                    echo "<td><a href='edit_donor.php?id=$user_data[id]'>Edit</a> | <a href='delete_donor.php?id=$user_data[id]'>Delete</a></td></tr>";
                                                }
                                                ?>
