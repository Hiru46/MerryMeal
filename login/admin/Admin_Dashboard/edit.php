...
if(isset($_POST['update']))
{
	...
	// update user data
	$result = mysqli_query($mysqli, "UPDATE crud_db SET mondaymeal='$mondaymeal',tuesdaymeal='$tuesdaymeal',wednessdaymeal='$wednessdaymeal',thursdaymeal='$thursdaymeal',fridaymeal='$fridaymeal' WHERE id=$id");
...
$result = mysqli_query($mysqli, "SELECT * FROM crud_db WHERE id=$id");
	...
	<div class="authincation d-flex flex-column flex-lg-row flex-column-fluid">
		...
		<div class="container flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
			<div class="d-flex justify-content-center h-100 align-items-center">
					...
					<div><a href="index.php">Home</a><br/><br/>
