...
$result = mysqli_query($mysqli, "SELECT * FROM partner ORDER BY id DESC");
?>
							...
							<div class="card-header flex-wrap border-0 p-0 justify-content-start">
								<div class="table-tabs mr-2 mb-3 mr-auto">
									<ul class="nav nav-tabs" role="tablist">
										<li class="nav-item">
                                           <div class="d-flex flex-wrap mb-3"><a href="add_partner.php" data-target="#addContactModal" class="btn btn-outline-primary  mr-auto mb-2">Add New Partner</a>	
										</li>
										...
										<div class="table-responsive rounded table-hover">
											<table class="table text-black card-table  mb-4 table-responsive-lg dataTablesCard" id="dataTable1">
                                                ...
                                                while($user_data = mysqli_fetch_array($result)) {
                                                    ...
                                                    echo "<td>".$user_data['Qualifications']."</td>";
                                                    echo "<td>".$user_data['Organization']."</td>";
                                                    echo "<td>".$user_data['Org_Email']."</td>";
                                                    echo "<td>".$user_data['Org_Address']."</td>";
                                                    echo "<td>".$user_data['service_period']."</td>";
                                                    echo "<td>".$user_data['Proof']."</td>";
                                                    
                                                    echo "<td><a href='edit_partner.php?id=$user_data[id]'>Edit</a> | <a href='delete_partner.php?id=$user_data[id]'>Delete</a></td></tr>";
                                                }
                                                ?>  
