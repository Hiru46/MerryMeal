	...
	<div class="authincation d-flex flex-column flex-lg-row flex-column-fluid">
		...
		<div class="container flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
			<div class="d-flex justify-content-center h-100 align-items-center">				
					...
					<div><a href="index_2.php">Go to Home</a><br/><br/>

						<form action="add_2.php" method="post" name="form1">
						...
						if(isset($_POST['Submit'])) {
							...
							$result = mysqli_query($mysqli, "INSERT INTO crud_2(saturdaymeal,sundaymeal) VALUES('$saturdaymeal','$sundaymeal')");

							// Show message when user added
							echo "Meal added successfully. <a href='index_2.php'>View Meals</a>";
						}
						?>
                    </div>
