...
$result = mysqli_query($mysqli, "SELECT * FROM volunteer ORDER BY id DESC");
?>
							...
							<div class="card-header flex-wrap border-0 p-0 justify-content-start">
								<div class="table-tabs mr-2 mb-3 mr-auto">
									<ul class="nav nav-tabs" role="tablist">
										<li class="nav-item">
                                        <div class="d-flex flex-wrap mb-3"><a href="add_volun.php" data-target="#addContactModal" class="btn btn-outline-primary  mr-auto mb-2">Add New Volunteer</a>	
										</li>
                                                ...
                                                <tr>  
                                                   ...
                                                   <?php
                                                    while($user_data = mysqli_fetch_array($result)) {
                                                        ...
                                                        echo "<td><a href='edit_volun.php?id=$user_data[id]'>Edit</a> | <a href='delete_volun.php?id=$user_data[id]'>Delete</a></td></tr>";
                                                    }
                                                    ?> 
