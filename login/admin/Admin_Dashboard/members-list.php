							...
							<div class="card-header flex-wrap border-0 p-0 justify-content-start">
								<div class="table-tabs mr-2 mb-3 mr-auto">
									<ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item">
                                           <div class="d-flex flex-wrap mb-3"><a href="add_member.php" data-target="#addContactModal" class="btn btn-outline-primary  mr-auto mb-2">Add New Member</a>	
										</li>
											...
											<table class="table text-black card-table  mb-4 table-responsive-lg dataTablesCard" id="dataTable1">
                                                ...
                                                <tr>  
                                                    ...
                                                    while($user_data = mysqli_fetch_array($result)) {
                                                        ...
                                                        echo "<td>".$user_data['Nic']."</td>";
                                                        echo "<td>".$user_data['idProof']."</td>";
                                                        echo "<td>".$user_data['why']."</td>";
                                                        echo "<td>".$user_data['issueProof']."</td>";
                                                        echo "<td>".$user_data['email']."</td>";        
                                                        echo "<td>".$user_data['password']."</td>";
                                                        echo "<td><a href='edit_member.php?id=$user_data[id]'>Edit</a> | <a href='delete_member.php?id=$user_data[id]'>Delete</a></td></tr>";
                                                    }
                                                    ?>
