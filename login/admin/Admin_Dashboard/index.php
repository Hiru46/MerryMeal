...
$result = mysqli_query($mysqli, "SELECT * FROM crud_db ORDER BY id DESC");
?>
                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h1>Menu Plan for this Week</h1>
                            <p class="mb-0">Weekly update Hot noon meal(Breakfast & Lunch)</p>
                        </div>
							...
							<div class="card-header flex-wrap border-0 p-0 justify-content-start">
								<div class="table-tabs mr-2 mb-3 mr-auto">
									<ul class="nav nav-tabs" role="tablist">
                                        <li class="nav-item">
                                           <div class="d-flex flex-wrap mb-3"><a href="add.php" data-target="#addContactModal" class="btn btn-outline-primary  mr-auto mb-2">Add New Meal</a>
										</li>
										...
										<div class="table-responsive rounded table-hover">
											<table class="table text-black card-table  mb-4 table-responsive-lg dataTablesCard" id="dataTable1">
                                                ...
                                                while($user_data = mysqli_fetch_array($result)) {
                                                    echo "<tr>";
                                                    echo "<td>".$user_data['mondaymeal']."</td>";
                                                    echo "<td>".$user_data['tuesdaymeal']."</td>";
                                                    echo "<td>".$user_data['wednessdaymeal']."</td>";
                                                    echo "<td>".$user_data['thursdaymeal']."</td>";
                                                    echo "<td>".$user_data['fridaymeal']."</td>";
		...
		<div class="content-body">
            <div class="container-fluid">
                ...
                <div class="row">
					...
					<a href="index_2.php"><button type="submit" class="btn btn-primary btn-block" id="dz-signup-submit">Update frozen meals planning</button></a>
                </div>
            </div>
        </div>
