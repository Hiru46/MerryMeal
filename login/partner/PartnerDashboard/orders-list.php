...
<head>
    ...
    <title>Merry Meal - Restaurant Dashboard </title>
    <!-- Favicon icon -->
...
<body>
    ...
    *************-->
    <div id="main-wrapper">
                                                ...
                                                <tr>  
                                                    ...
                                                    if (mysqli_num_rows($sql)>0) {  
                                                            ...
                                                            <tr>  
                                                                ...
                                                                <td>  
                                                                    <select onchange="rider_dashboard(this.options[this.selectedIndex].value,'<?php echo $row['id'] ?>')">  
      ...
      function rider_dashboard(value,id){  
           //alert(id);  
           let url = "http://localhost/MerryMeal/login/rider/rider_dashboard/orders-list.php";  
